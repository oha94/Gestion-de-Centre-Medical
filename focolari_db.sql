...
--
-- Déchargement des données de la table `app_menus`
--

INSERT INTO `app_menus` (`id`, `code`, `libelle`, `categorie`, `icone`, `ordre`, `actif`) VALUES
(1, 'dashboard', 'Tableau de bord', 'Général', '🏠', 1, 1),
(2, 'patients', 'Patients', 'Médical', '👥', 10, 1),
(3, 'consultation', 'Consultation', 'Médical', '🩺', 11, 1),
(4, 'laboratoire', 'Laboratoire', 'Médical', '🔬', 12, 1),
(5, 'infirmier', 'Infirmier', 'Médical', '💉', 13, 1),
(6, 'hospitalisation', 'Hospitalisation', 'Médical', '🏨', 14, 1),
(7, 'assurances', 'Assurances', 'Administration', '🛡️', 20, 1),
(8, 'caisse', 'Caisse & Factures', 'Administration', '💰', 21, 1),
(9, 'stock', 'Gestion Stock', 'Logistique', '📦', 30, 1),
(10, 'parametres', 'Paramètres', 'Configuration', '⚙️', 40, 1);
...
--
-- Déchargement des données de la table `app_parametres_app`
--
...
--
-- Déchargement des données de la table `app_parametres_entreprise`
--
...
(1, 'Centre Médical FOCOLARI', NULL, 'man', 'MAN', 'Côte d\'Ivoire', '+225 01 01 01 01', NULL, 'contact@focolari.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-12-27 05:53:08');
...
(1, 'Administrateur', 'Accès complet à toutes les fonctionnalités', '#e74c3c', 1, '2025-12-24 00:00:41', '2025-12-27 04:31:27', 1, 1, 1),
(2, 'Médecin', 'Accès aux consultations et dossiers patients', '#3498db', 1, '2025-12-24 00:00:41', '2025-12-24 00:00:41', 1, 1, 1),
(3, 'Infirmier', 'Accès aux soins infirmiers et hospitalisation', '#2ecc71', 1, '2025-12-24 00:00:41', '2025-12-24 00:00:41', 1, 1, 1),
(4, 'Laborantin', 'Accès au laboratoire et analyses', '#9b59b6', 1, '2025-12-24 00:00:41', '2025-12-24 00:00:41', 1, 1, 1),
(5, 'Caissier', 'Accès à la caisse et facturation', '#f39c12', 1, '2025-12-24 00:00:41', '2025-12-27 04:31:32', 0, 0, 0),
(6, 'Pharmacien', 'Accès à la gestion du stock pharmaceutique', '#1abc9c', 1, '2025-12-24 00:00:41', '2025-12-24 00:00:41', 1, 1, 1),
(7, 'Réceptionniste', 'Accès à l accueil et gestion des rendez-vous', '#95a5a6', 1, '2025-12-24 00:00:41', '2025-12-24 00:00:41', 1, 1, 1),
(11, 'Gestionnaire', 'Gère les stocks et les commandes', '#e67e22', 1, '2025-12-27 04:10:46', '2025-12-27 04:10:46', 0, 1, 1);
...
--
-- Déchargement des données de la table `app_role_permissions`
--
...
--
-- Déchargement des données de la table `caisse_recouvrements_details`
--
...
(1, 'Centre Médico-Social FOCOLARI', NULL, NULL, NULL, NULL);
...
--
-- Déchargement des données de la table `clotures_journalieres`
--
...
(4, 'Consultation Générale', 2000, 'CONSULTATION');
...
--
-- Déchargement des données de la table `stock_articles`
--
...
('0001', 1, 'paracetamol', 1, 19, 5, 'Unité', 2000, 'Boîte', 'Plaquette', 1, 3500.00, NULL),
('21212', 2, 'paracetamol', 1, 3, 5, 'Unité', 2000, 'Boîte', 'Plaquette', 1, 2000.00, NULL),
('1222', 3, 'paracetamol', 1, 3, 5, 'Unité', 2000, 'Boîte', 'Plaquette', 1, 2500.00, NULL),
('88', 4, 'sasa', 1, 2, 5, 'Unité', 2999, 'Boîte', 'Plaquette', 1, 2000.00, NULL),
('sz', 5, 'sz', 1, 0, 5, 'Unité', 22, 'Boîte', 'Plaquette', 1, 22.00, NULL),
('0003', 6, 'SEKISSAN SIROP', 1, 4, 5, 'Unité', 2000, 'Boîte', 'Plaquette', 1, 2500.00, NULL),
('002', 7, 'DYNAPAR', NULL, 0, 5, 'Unité', 1000, 'Boîte', 'Plaquette', 1, 2500.00, NULL),
('003', 8, 'SMECTA', 1, 3, 5, 'Unité', 500, 'Boîte', 'Plaquette', 1, 1500.00, NULL),
('004', 9, 'AMOXICILLINE ', 4, 1, 5, 'Unité', 2000, 'Boîte', 'Plaquette', 1, 3000.00, NULL),
('004D', 10, 'Detail amoxiciline', 1, 2, 5, 'Unité', 20, 'Boîte', 'Plaquette', 100, 100.00, 9);
...
--
-- Déchargement des données de la table `stock_avoirs_fournisseurs`
--
...
(3, 'BL-005-A', '2025-12-24', 4, 4000.00, 'Validé', '', '2025-12-24 05:48:40', '2025-12-24 05:48:40'),
(4, 'BL-001-A', '2025-12-24', 5, 20000.00, 'Validé', '', '2025-12-24 18:04:56', '2025-12-24 18:04:56');
...
--
-- Déchargement des données de la table `stock_avoir_details`
--

INSERT INTO `stock_avoir_details` (`id`, `avoir_id`, `article_id`, `quantite`, `prix_unitaire`, `motif`, `total_ligne`, `created_at`) VALUES
(1, 1, 1, 2.00, 2000.00, 'Déduit facture', 4000.00, '2025-12-24 05:03:02'),
(2, 2, 8, 6.00, 500.00, 'Rejeté', 3000.00, '2025-12-24 05:11:04'),
(3, 2, 9, 6.00, 2000.00, 'Déduit facture', 12000.00, '2025-12-24 05:11:04'),
(4, 2, 6, 6.00, 2000.00, 'Remplacé', 12000.00, '2025-12-24 05:11:05'),
(5, 3, 1, 2.00, 2000.00, 'Remplacé', 4000.00, '2025-12-24 05:48:40'),
(6, 4, 1, 10.00, 2000.00, 'Déduit facture', 20000.00, '2025-12-24 18:04:56');
...
--
-- Déchargement des données de la table `stock_avoir_mouvements`
--
...
(1, 1, 1, 2.00, 'Déduit', 73.00, 73.00, '2025-12-24 05:03:02'),
(2, 3, 9, 6.00, 'Déduit', 9.00, 9.00, '2025-12-24 05:11:04'),
(3, 4, 6, 6.00, 'Remplacé', 14.00, 20.00, '2025-12-24 05:11:05'),
(4, 5, 1, 2.00, 'Remplacé', 73.00, 75.00, '2025-12-24 05:48:40'),
(5, 6, 1, 10.00, 'Déduit', 65.00, 65.00, '2025-12-24 18:04:56');
...
--
-- Déchargement des données de la table `stock_bl_details`
--
...
--
-- Déchargement des données de la table `stock_bons_livraison`
--
...
--
-- Déchargement des données de la table `stock_bons_retour`
--
...
--
-- Déchargement des données de la table `stock_br_details`
--

INSERT INTO `stock_br_details` (`id`, `br_id`, `article_id`, `quantite_retour`, `prix_achat_ht`, `motif`, `total_ligne`, `created_at`) VALUES
(1, 1, 1, 2.00, 2000.00, 'Facturé non livré', 4000.00, '2025-12-23 18:32:05'),
(2, 2, 4, 6.00, 1000.00, 'Bon état', 6000.00, '2025-12-23 21:23:16'),
(3, 3, 8, 6.00, 500.00, 'Péremption', 3000.00, '2025-12-24 05:09:50'),
(4, 3, 9, 6.00, 2000.00, 'Cassé', 12000.00, '2025-12-24 05:09:50'),
(5, 3, 6, 6.00, 2000.00, 'Facturé non livré', 12000.00, '2025-12-24 05:09:50'),
(6, 4, 1, 2.00, 2000.00, 'Péremption', 4000.00, '2025-12-24 05:48:04'),
(7, 5, 1, 10.00, 2000.00, 'Péremption', 20000.00, '2025-12-24 18:04:27');
...
--
-- Déchargement des données de la table `stock_deconditionnements`
--
...
(1, 'QUICK-1766622078768', '2025-12-25', 9, 1, NULL, 10, 100, NULL, 100, NULL, NULL, NULL, NULL, 'Validé', '2025-12-25 00:21:18', 'System', '2025-12-25 00:21:18', NULL, NULL, NULL),
(2, 'QUICK-1766622152301', '2025-12-25', 9, 1, NULL, 10, 100, NULL, 100, NULL, NULL, NULL, NULL, 'Validé', '2025-12-25 00:22:32', 'System', '2025-12-25 00:22:32', NULL, NULL, NULL);
...
--
-- Déchargement des données de la table `stock_fournisseurs`
--
...
--
-- Déchargement des données de la table `stock_inventaires`
--
...
--
-- Déchargement des données de la table `stock_inventaire_lignes`
--
...
--
-- Déchargement des données de la table `stock_paiements_fournisseurs`
--
...
(1, 'PAY-BL-004-001', 17, 1, 25000.00, 'Chèque', NULL, '2025-12-24', NULL, 'admin', '2025-12-24 07:48:12', '2025-12-24 07:48:12'),
...
--
-- Déchargement des données de la table `stock_rayons`
--
...
--
-- Déchargement des données de la table `stock_regularisations`
--
...
--
-- Déchargement des données de la table `stock_rubriques`
--

INSERT INTO `stock_rubriques` (`id`, `libelle`, `type`) VALUES
(1, 'Péremption', 'SORTIE'),
(3, 'Casse / Détérioration', 'SORTIE'),
(5, 'Avarié', 'SORTIE'),
...
(1, 4, 'Pédiatrie', 2000, 600, 1400, 'CASH', '2025-12-22 16:05:12', 'PAYE', 0, 'ACTE', NULL, NULL, NULL, NULL, NULL, 1, '2025-12-26 01:06:04'),
(2, 4, '🏥 Hospitalisation (CHAMBRE A 1/LIT A12) - 2 jour(s)', 100000, 30000, 70000, 'CASH', '2025-12-22 16:52:02', 'PAYE', 0, 'ACTE', NULL, NULL, NULL, NULL, NULL, 1, '2025-12-26 01:06:04'),
(3, 4, 'Pédiatrie', 2000, 600, 1400, 'CASH', '2025-12-22 16:52:02', 'PAYE', 0, 'ACTE', NULL, NULL, NULL, NULL, NULL, 1, '2025-12-26 01:06:04'),
...
(6, 4, 'Séjour CHAMBRE A 1 / LIT A12 (2 j)', 100000, 30000, 70000, '', '2025-12-25 03:17:27', 'PAYE', 0, 'HOSPITALISATION', NULL, NULL, NULL, NULL, NULL, 1, '2025-12-26 01:06:04'),
...
(9, 4, 'Consultation Générale (x1)', 2000, 600, 1400, '', '2025-12-25 03:34:31', 'PAYE', 0, 'ACTE', NULL, NULL, NULL, NULL, NULL, 1, '2025-12-26 01:06:04'),
...
(14, 4, 'Séjour CHAMBRE A 1 / LIT A12 (x4)', 200000, 200000, 0, 'CASH', '2025-12-25 14:41:22', 'PAYE', 0, 'HOSPITALISATION', NULL, NULL, '', NULL, NULL, 1, '2025-12-26 01:06:04'),
(17, 1, 'Séjour CHAMBRE A 1 / LIT A2 (x10)', 250000, 250000, 0, '', '2025-12-25 16:49:47', 'PAYE', 0, 'HOSPITALISATION', NULL, NULL, '', NULL, 'TKT-251225-856', 1, '2025-12-26 01:06:04'),
(18, 1, 'sasa (x1)', 2000, 2000, 0, '', '2025-12-25 16:54:02', 'PAYE', 0, 'MEDICAMENT', 4, NULL, '', NULL, 'TKT-251225-375', 1, '2025-12-26 01:06:04'),
(19, 4, 'Consultation Générale (x1)', 2000, 2000, 0, '', '2025-12-25 17:58:55', 'PAYE', 0, 'ACTE', NULL, NULL, '', NULL, 'TKT-251225-008', 1, '2025-12-26 01:06:04'),
...
--
-- Déchargement des données de la table `ventes_supprimees`
--
...
--
-- Déchargement des données de la table `ventes_transferts`
--
...
--
-- Déchargement des données de la table `ventes_transferts_items`
--
